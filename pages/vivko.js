...
export default function Vivko() {
    ...
    hu: [
      {
        ...
        sub:
          "A nyertes egy teljes körűen megszervezett, 9 nap 7 éjszakás utazást nyer New Yorkba, Washington DC-be és a Niagara-vízeséshez, Vivkó és a Grand Slam Travel kíséretében.\n\nAz utazás teljes mértékben megszervezett, így sem tapasztalatra, sem nyelvtudásra nincs szükség. A nyeremény tartalmazza az ESTA ügyintézést, a repülőjegyeket, a transzfereket, a szállodát reggelivel, több nevezetesség belépőjét, valamint egy egynapos washingtoni és egy egynapos Niagara-vízesés kirándulást. Csak az ebédhez és vacsorához, illetve a költőpénzhez szükséges összeget kell magaddal hoznod.\n\nA rendszer kiválasztja azt a 10 versenyzőt, aki 2026. május 29. 23:59-ig (HUN) a legrövidebb idő alatt, hibátlanul teljesíti a kvízt. Ők lesznek a 2. forduló versenyzői.\n\nA Top 10 leggyorsabb versenyző felhasználóneve folyamatosan frissülő leaderboardon jelenik meg a GrandLucky Travel weboldalán. Az első forduló lezárulta után minden sikeres felhasználónév felkerül a weboldalra 2026. május 30-án 16:00-kor (CT) a befejezési időkkel együtt.",
        ui: "cta",
        home: "FŐOLDAL",
        play: "JÁTSZOM!",
      },
    ...
    en: [
      {
        ...
        sub:
          "The winner will receive a fully organized 9-day, 7-night trip to New York, Washington DC, and Niagara Falls accompanied by Vivko and Grand Slam Travel.\n\nThe trip is fully organized, so no prior experience or language skills are required. The prize includes ESTA processing, flights, transfers, hotel with breakfast, tickets to several attractions, and a one-day trip to Washington DC and Niagara Falls. You only need to bring your own money for lunch, dinner, and spending money.\n\nThe system will select the 10 contestants who completed the trivia correctly in the shortest time until May 29, 2026 11:59 PM (HUN). They will qualify for Round 2 (the live contest).\n\nThe Top 10 fastest contestants' usernames will be listed on the continuously refreshing GrandLucky Travel leaderboard. After the first round closes, all successful usernames will be published on May 30, 2026 at 16:00 CT together with their completion times.",
        ui: "cta",
        home: "HOME",
  ...
  return (
    <main className={`hero s-${S.id} blur-${S.blur} ${uaClass}`}>
      ...
      <section className="text text-draw">
        <h1 className="title">
