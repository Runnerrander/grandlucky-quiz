...
export default function Welcome() {
  ...
  const t = {
    hu: {
      ...
      subBottom: "és a Niagara-vízesést (kanadai oldal is) Vivkóval júliusban!",
    ...
    en: {
      ...
      subTop: "Explore New York, Washington DC",
      subBottom:
        "and the Niagara Falls (Canadian side too) with Vivko in July!",
  ...
  return (
    <main className={`hero ${lang === "hu" ? "is-hu" : "is-en"}`}>
      ...
      <div className="overlay">
        <div className="text">
          ...
          <p className="tagline">
            ...
            <span className="block blink">{c.tagBottom}</span>
          </p>
        </div>
      ...
      <style jsx>{`
        ...
        .blink {
          animation: blinkY 1.1s infinite;
        }
        @keyframes blinkY {
          0%,
          49% {
