...
export default function Welcome() {
  ...
  const t = {
    hu: {
      ...
      tagBottom:
        "egy ebéd áráért velünk utazhatsz! $24.99",
      href: "/winners",
    },
    en: {
      script: "Welcome",
      ...
      subBottom:
        "with Vivko in Summer 2026!",
      cta: "CLICK FOR DETAILS",
      tagTop: "With a little knowledge and speed",
      tagBottom:
        "you can travel with us for the price of a lunch! $24.99",
      href: "/winners",
    },
  };
  ...
  return (
    <main className={`hero ${lang === "hu" ? "is-hu" : "is-en"}`}>
      ...
      {/* keep your original styles block unchanged */}
    </main>
  );
}