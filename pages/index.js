...
const OTHERS = [
  ...
  {"username":"GL-LFJT","time_ms":61245},{"username":"GL-0KYS","time_ms":61551},{"username":"GL-JDG3","time_ms":63072},
  ...
  {"username":"GL-D3S5","time_ms":103216},{"username":"GL-5XWQ","time_ms":105621},{"username":"GL-HCNP","time_ms":106663},
...
const STR = {
  ...
  hu: {
    ...
    heroSub: "Hamarosan új játék indul. vMARK-1012",
  ...
  return (
    <>
      ...
      <style jsx>{`
        ...
        .infoCard{ background:#fbf1e1; border:1px solid var(--border); border-radius:12px; padding:12px 14px; margin-bottom:12px; box-shadow:0 12px 24px rgba(0,0,0,0.05); }

        .section{ margin-top:12px; border-radius:14px; overflow:hidden; box-shadow:0 10px 22px rgba(0,0,0,0.06); background:var(--card); border:1px solid var(--border); }
        .sectionHeaderBar{ background:var(--thead); font-weight:800; padding:10px 14px; border-bottom:1px solid var(--border); }
        .sectionHeader{ display:flex; justify-content:flex-end; padding:10px 12px; }
        ...
        .tableHeader{ position:sticky; top:0; z-index:1; display:grid; grid-template-columns:1fr 160px; background:var(--thead); border-bottom:1px solid var(--border); font-size:13px; letter-spacing:.2px; }
        .tableHeader.three{ grid-template-columns:1fr 160px 140px; }

        .tableRow{ display:grid; grid-template-columns:1fr 160px; border-bottom:1px solid var(--row-sep); background:#fff; }
        ...
        .user,.time{ font-variant-numeric: tabular-nums; }

        /* MOBILE PORTRAIT: keep two columns, make time column narrower */
