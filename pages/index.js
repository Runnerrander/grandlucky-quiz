...
export default function Welcome() {
  ...
  const t = {
    hu: {
      ...
      subTop: "Fedezd fel a karácsonyi és adventi szezont",
      subBottom: "Vivkóval New Yorkban!",
    ...
    en: {
      ...
      subTop: "Explore the Christmas and Advent Season",
      subBottom: "with Vivko in New York!",
